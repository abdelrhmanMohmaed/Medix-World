                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="card my-3 py-5">
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div
                                                                        class="d-flex card-body justify-content-between">
                                                                        ...
                                                                        <div class="col-md-9 show-more"
                                                                            ...
                                                                            <div class="d-flex flex-column ">
                                                                                ...
                                                                                <h6 class="mb-0">
                                                                                    ...
                                                                                    <li class="list-group-item">
                                                                                        ...
                                                                                        @for ($i = 1; $i <= $goldStars; $i++)
                                                                                            <i
                                                                                                class="icon-gold fa-solid fa-star"></i>
                                                                                        @endfor
                                                                                ...
                                                                                <h6 class="mb-0 my-2">
                                                                                    <i
                                                                                        class="icon fa-solid fa-stethoscope mx-2"></i>
                                                                                    <span
                                                                                        id="summary{{ $loop->index }}"
                                                                                        class="summary">
                                                                                        {{ substr($item->getTranslation('summary', app()->getLocale()), 0, 30) }}
                                                                                    </span>
                                                                                    <a id="readMore{{ $loop->index }}"
                                                                                        class="readBtn"
                                                                                ...
                                                                                @foreach ($item->user->phones as $itemPhone)
                                                                                    <h6 class="mb-0 my-2">
                                                                                        <i
                                                                                            class="icon fa-solid fa-phone-volume mx-2"></i>
                                                                                        {{ $itemPhone->tel }}
                                                                ...
                                                                <div class="col-md-3 schedulesModel">
                                                                    ...
                                                                    <div class="text-center">
                                                                        <button
                                                                            class="btn btn-sm btn-primary btn-show-more"
