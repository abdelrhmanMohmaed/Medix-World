      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            ...
            <div class="mt-5">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total Patients</label>
              <h5 class="fw-bolder mb-0">{{ $all_users->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-success"></span> Active Patients</label>
              <h5 class="fw-bolder mb-0">{{ $active_users->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-danger"></span> Inactive Patients</label>
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            ...
            <div class="mt-5">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total Service Providers</label>
              <h5 class="fw-bolder mb-0">{{ $all_service_providers->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-success"></span> Active Service Providers</label>
              <h5 class="fw-bolder mb-0">{{ $active_service_providers->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-danger"></span> Inactive Service Providers</label>
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            ...
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total</label>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            <div class="mt-5">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total Majors</label>
              <h5 class="fw-bolder mb-0">{{ $all_majors->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-success"></span> Active Majors</label>
              <h5 class="fw-bolder mb-0">{{ $active_majors->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-danger"></span> Inactive Majors</label>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            <div class="mt-5">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total Cities</label>
              <h5 class="fw-bolder mb-0">{{ $all_cities->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-success"></span> Active Cities</label>
              <h5 class="fw-bolder mb-0">{{ $active_cities->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-danger"></span> Inactive Cities</label>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mb-3">
          ...
          <div class="d-flex justify-content-between align-items-baseline mb-2">
            <div class="mt-5">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-primary"></span> Total Advices</label>
              <h5 class="fw-bolder mb-0">{{ $all_advices->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-success"></span> Active Advices</label>
              <h5 class="fw-bolder mb-0">{{ $active_advices->count()}}</h5>
            </div>
            <div class="mt-5 d-inline">
              <label class="d-flex align-items-center tx-10 text-uppercase fw-bolder"><span class="p-1 me-1 rounded-circle bg-danger"></span> Inactive Advices</label>
