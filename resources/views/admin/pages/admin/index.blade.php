            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-5">
                        <a href="{{ route('admins.admins.create') }}" class="btn-sm btn-primary btn-icon-text">
                            ...
                            <tbody>
                                @foreach ($admins as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admins.admins.show', $item->id) }}"
                                                class="btn-sm btn-secondary btn-icon-text"> <i
                                                    class="fa-solid fa-eye p-1"></i>view
                                            </a>

                                            <a href="{{ route('admins.admins.edit', $item->id) }}"
