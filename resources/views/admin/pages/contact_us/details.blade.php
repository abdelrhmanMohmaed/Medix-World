            ...
            <div class="example m-3">
                ...
                <div class="row mb-3">
                    <label for="exampleInputUsername2"
                        class="col-sm-2 col-form-label m-2">{{ __('dashboard.name') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-3">
                    <label for="exampleInputUsername2"
                        class="col-sm-2 col-form-label m-2">{{ __('dashboard.status') }}</label>
                    <div class="col-sm-8">
                        @if ($message->active == 1)
                ...
                <div class="row mb-3">
                    <label for="exampleInputEmail2"
                        class="col-sm-2 col-form-label m-2">{{ __('dashboard.subject') }}</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="title[ar]" id="title_ar"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input class="form-control" maxlength="25" name="defaultconfig" id="defaultconfig" type="text"
                            value="{{ $message->message }}" disabled>
                    </div>
                </div>
