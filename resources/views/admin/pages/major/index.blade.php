          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <td>{{ $loop->iteration }}</td>
                ...
                <td>
                  <input type="hidden" id="major" value="{{ $item->id }}">
                  @if ($item->active == 0)
                ...
                <td colspan="3">
                  ...
                  <a href="{{ route('admins.majors.destroy', $item->id) }}" class="btn-sm btn-danger btn-icon-text"> <i class="fa-solid fa-trash"></i> Delete
                  </a>
