...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admins.majors.index') }}">{{ __('dashboard.major-index') }} </a>
            </li>
                ...
                <div class="row mb-3">
                    <div class="col-lg-2">
                        <label for="exampleInputUsername2"
                            class="col-form-label">{{ __('dashboard.name-major-en') }}</label>
                    </div>
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="name[en]" id="name_en"
                            value="{{ $major->getTranslation('name', 'en') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="name[ar]" id="name_ar"
                            value="{{ $major->getTranslation('name', 'ar') }}">
                    </div>
                </div>

                <div class="action d-flex mt-5 justify-content-end">
                    <button type="submit" class="btn btn-primary me-2">Submit</button>
                    <a href="{{ route('admins.majors.index') }}" class="btn btn-secondary">
                        Cancel
                    </a>
                </div>
            </form>
