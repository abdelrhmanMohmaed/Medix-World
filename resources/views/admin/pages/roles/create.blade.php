        ...
        <div class="example m-4">
            <form class="forms-sample" action="{{ route('admins.roles.store') }}" method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="name" id="name_en"
                            value="{{ old('name') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-2">
                        <label for="exampleInputUsername2"
                            class="col-form-label">{{ __('dashboard.name-permissions') }}</label>
                    </div>
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-6">
                                @foreach ($leftColumn as $item)
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" name="permissions[]"
                                            id="permission_{{ $item->id }}" value="{{ $item->name }}">
                ...
                <div class="action d-flex mt-5 justify-content-end">
                    ...
                    <a href="{{ route('admins.roles.index') }}" class="btn btn-secondary">
                        Cancel
                    </a>
                </div>
            </form>
