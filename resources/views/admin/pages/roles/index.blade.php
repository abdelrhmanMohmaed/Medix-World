    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-end mb-5">
          ...
          <a href="{{ route('admins.roles.create') }}" class="btn-sm btn-primary btn-icon-text"> <i class="fa-solid fa-plus"></i> Add role
          </a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="3">
                  ...
                  <a href="{{ route('admins.roles.edit', $item->id) }}" class="btn-sm btn-primary btn-icon-text m-2 "><i class="fa-solid fa-pen-to-square"></i> edit
                  </a>


                  <form method="POST" action="{{ route('admins.roles.destroy', $item->id) }}" class="d-inline"> 
                    @csrf
                    @method('delete')
