...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admins.cities.index') }}">{{ __('dashboard.region-index') }} </a>
            </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-5">
                        <a href="{{ route('admins.regions.create') }}" class="btn-sm btn-primary btn-icon-text">
                            <i class="fa-solid fa-plus"></i> Add New Region
                        </a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch mb-2" id="status">
                                                <form method="get"
                                                    action="{{ route('admins.regions.status', $item->id) }}"
                                                    class="d-inline">
                                                    @csrf
                                        ...
                                        <td>
                                            <a href="{{ route('admins.regions.edit', $item->id) }}"
                                            ...
                                            <form method="POST" action="{{ route('admins.regions.destroy', $item->id) }}"
                                                ...
                                                <button type="submit" class="btn btn-danger btn-xs btn-icon-text p-1"
                                                    onclick="return confirm('Are you sure to delete this region')"><i
