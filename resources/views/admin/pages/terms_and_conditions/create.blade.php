...
@section('content')
    ...
    <div class="card">
        <div class="example m-4">
            ...
            <form class="forms-sample" action="{{ route('admins.terms.store') }}" method="post"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" placeholder="Title (EN)" class="form-control" name="title[en]" id="title_en"
                            value="{{ old('title.en') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" placeholder="Title (AR)" class="form-control" name="title[ar]" id="title_ar"
                            value="{{ old('title.ar') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <textarea placeholder="Description (AR)" class="form-control simpleMdeExample" id="tinymceExample"
                            name="description[ar]">{{ old('description.en') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <textarea placeholder="Sub-Description (EN)" class="form-control simpleMdeExample" id="tinymceExample"
                            name="sub_description[en]">{{ old('sub_description.en') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <textarea placeholder="Sub-Description (AR)" class="form-control simpleMdeExample" id="tinymceExample"
                            name="sub_description[ar]">{{ old('sub_description.ar') }}</textarea>
                    </div>
                </div>
