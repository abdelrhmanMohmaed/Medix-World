            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-5">
                        <a href="{{ route('admins.users.create') }}" class="btn-sm btn-primary btn-icon-text">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-switch mb-2" id="status">
                                                <form method="get" action="{{ route('admins.users.status', $item->id) }}"
                                                    class="d-inline">
                                                    @csrf
                                        ...
                                        <td>
                                            <a href="{{ route('admins.users.show', $item->id) }}"
                                            ...
                                            <form method="POST" action="{{ route('admins.users.destroy', $item->id) }}"
                                                class="d-inline">
                                                @csrf
                                                @method('delete')
