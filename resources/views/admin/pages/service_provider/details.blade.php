                ...
                <div class="card-body">
                    ...
                    <div class="example">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link" id="clinic-tab" data-bs-toggle="tab" data-bs-target="#" role="tab"
                                    aria-controls="clinic" aria-selected="false">Schedule</a>
                            </li> --}}
                        </ul>
                        <div class="tab-content border border-top-0 p-3" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="specialization" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <a href="{{ url($service_provider->medical_card) }}" class="form-control"
                                            target="_blanck">
                    ...
                    <div class="action d-flex mt-5 justify-content-center">
                        ...
                        <form
                            ...
                            <button type="submit" class="btn-sm btn-danger btn-icon-text m-1"><i
                                    class="fa-solid fa-thumbs-down p-1"></i>Reject</button>
                        </form>
                    </div>
                </div>
            </div>
