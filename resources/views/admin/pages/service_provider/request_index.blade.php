...
@section('title', 'Service Provider Pending Requests')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a
                    href="{{ route('admins.service_provider.requests', $service_provider_requests->first()->status) }}">
                    {{ __('dashboard.service-provider') }}
                </a>
            </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-5">
                        ...
                        <a href="{{ route('admins.service_provider.create') }}" class="btn-sm btn-primary btn-icon-text">
                            <i class="fa-solid fa-plus"></i> Add New Service Provider
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-middle">
                                                <a href="{{ route('admins.service_provider.show_request', $item->id) }}"
