...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route ('admins.service_provider.requests','pending') }}">{{ __('dashboard.service-provider')}} </a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="example">
                    ...
                    <form action="{{ route('admins.service_provider.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="tab-content border border-top-0 p-3" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="personal_info" role="tabpanel" aria-labelledby="personal_info-tab">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="defaultconfig" type="text" name="name[en]" value="{{ old('name.en') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="text" name="name[ar]" value="{{ old('name.ar') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="file" id="img"  name="profileImage" value="{{ old('profileImage') }}">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="specialization" role="tabpanel" aria-labelledby="specialization-tab">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input name="medical_association_card" id="medical_association_card" value="{{ old('medical_association_card') }}" type="file">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="clinic" role="tabpanel" aria-labelledby="clinic-tab">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="tel" id="clinic_tel" value="{{ old('clinicTel') }}" name="clinicTel" autocomplete="tel" class="form-control" placeholder="telephone 1">
                                        <input type="tel" id="clinic_tel_two" value="{{ old('clinicTelTwo') }}" name="clinicTelTwo" autocomplete="tel" class="form-control mt-1" placeholder="telephone 2">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" type="number" id="booking_price" step="0.5" min="0.00" name="bookingPrice" placeholder="price in LE" value="{{ old('bookingPrice') }}">
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index) {
                        var option = '<option value="' + data[index].id + '">' + data[index].name.en + '</option>'
