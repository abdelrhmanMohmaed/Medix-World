        ...
        <div class="card-body">
            <div class="example m-4">
                <div class="d-flex justify-content-end mb-5">
                    ...
                    <a href="{{ route('admins.advices.edit', $advice->id) }}"
                        class="btn-sm btn-primary btn-icon-text m-1 "><i class="fa-solid fa-pen-to-square"></i>
                        edit
                    </a>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="title[en]" id="title_en"
                            value="{{ $advice->getTranslation('title', 'en') }}" disabled>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="title[ar]" id="title_ar"
                            value="{{ $advice->getTranslation('title', 'ar') }}" disabled>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="description[ar]" disabled>{{ $advice->getTranslation('description', 'ar') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
