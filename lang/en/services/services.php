...
return [
    ...
    // register section
    "register-services" => "Join today and be part of the healthcare transformation.",
    "register-services-hello" => "Discover a new world of opportunities and challenges. Join us today as a new healthcare service provider, and contribute to building the future of healthcare.",
    "register-services-happy" => "Register Your Medical Account Here.",
    
    'register-services-personal-information' => 'Personal Information',
    'register-services-full-name' => 'Full Name',
    "register-services-tel" => "Personal Tel Number",
    "register-services-profile-image" => "Profile Image",
    'register-services-email-address' => 'Email Address',
    "register-services-password" => "Password*",
    "register-services-confirm-password" => "Confirm Password*",
    "register-services-gender" => "Gender",
    "register-services-menu"=>"Open this menu",
    ...
    'register-medical-association-card' => "Medical Association Card",
    'register-services-summary' => 'Summary',
    'register-services-summary-details' => 'Write a summary that attracts followers',

    'register-services-information-about-the-clinic' => 'Information about the clinic',
    'register-services-cities' => 'cities',
    'register-services-regions' => 'regions',
    'register-services-address' => 'Address',    
    "register-services-address-detailed" => 'Detailed Address',
    'register-services-clinic-tel' => 'Clinic Tel',
